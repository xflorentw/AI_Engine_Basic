...
The AIE-ML graph can be simulated directly from a Python test bench using the AMD Vitis Functional Simulation (VFS) feature as describe in the tutorial 16. To run the VFS simulation using Python3:
```
cd vfs/python
